...
class RegisterPage(object): 
    ...
    def createPage(self): 
        ...
        Label(self.page, text = '姓名: ').grid(row=1, stick=W, pady=12) 
        Entry(self.page, textvariable=self.username).grid(row=1, column=1, stick=E) 
        Label(self.page, text = '工作: ').grid(row=2, stick=W, pady=12) 
        ...
        Label(self.page, text = '密码: ').grid(row=4, stick=W, pady=10) 
